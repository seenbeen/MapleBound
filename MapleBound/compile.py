...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "MapleBound Beta 1.0.py"
 
        #Name of program
        self.project_name = "MapleBound Beta 1.0"
 
        #Project url
        self.project_url = "TBD"
 
        #Version of program
        self.project_version = "0.1"
 
        #License of the program
        self.license = "License TBD"
 
        #Auhor of program
        self.author_name = "Shiyang Han & Weiyi Dai"
        self.author_email = "-"
